...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchButton.setOnClickListener{
            ...
            if(pinCode.length != 6)
            {
                Toast.makeText(this,"Not a Valid Pin Code",Toast.LENGTH_SHORT).show()
            }
            else
            {
        ...
        val request = JsonObjectRequest(Request.Method.GET,url,null,{
            ...
            try {
                ...
                for(i in 0 until centerArray.length()) {
                    ...
                    val price: String = centerObj.getString("fee_type")
                    ...
                    val center = CenterRVModel(
                        centerName,
                        centerAddress,centerFromTime,centerToTime,price,ageLimit,vaccineName,availableCapacity
                    )
